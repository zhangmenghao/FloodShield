...
public abstract class ForwardingBase implements IOFMessageListener {
    ...
    public static int FLOWMOD_DEFAULT_HARD_TIMEOUT = 1; // infinite
    ...
    protected static TableId FLOWMOD_DEFAULT_TABLE_ID = TableId.of(1);

    protected static boolean FLOWMOD_DEFAULT_SET_SEND_FLOW_REM_FLAG = true;// modify, send flow_removed
